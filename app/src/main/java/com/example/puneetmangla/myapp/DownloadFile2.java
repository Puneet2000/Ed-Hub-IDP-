...
/**
 * Created by puneet mangla on 22-01-2018.
 */

public class DownloadFile2 extends AsyncTask<String,Void,String>{
    public String username="";
    Context context;
    public DownloadFile2(Context ctx) {
        context=ctx;
    }
    @Override
    ...
    protected void onPostExecute(String result) {
        ...
        {
            Toast.makeText(context,"No news yet",Toast.LENGTH_LONG).show();

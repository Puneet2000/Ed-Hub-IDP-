...
public class addlink extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        heading=(EditText)findViewById(R.id.purp);
        feed=(EditText)findViewById(R.id.link);
        btn=(Button)findViewById(R.id.postlink);
        boomMenuButton=(BoomMenuButton)findViewById(R.id.bmb10);
    ...
    { String headin="";
        ...
        protected String doInBackground(String... strings) {
            String login_url="http://192.168.137.1/savelink.php?username="+username+"&purpose="+headin+"&link="+ URLEncoder.encode(content1);
